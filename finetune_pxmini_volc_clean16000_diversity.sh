...
--run_name volc_clean_16000_diversity_softmin \
--seed 42 \
--base_dir ./output \
--dtype bf16 \
...
--data.md0805_trainingset.base_info.indices_fpath /voyager-hackathon/home/hms/code/Protenix/mydata/md0805_training_ligand_prot_clean.csv \
--data.epoch_size 16000 \
--loss.weight.alpha_diversity 0.05 \
